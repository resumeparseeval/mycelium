...
- **Learning Loop** — Counter-triggered background self-review that persists memory entries and creates or patches skills after working sessions, with a hard tool whitelist and deterministic (non-LLM) triggers
